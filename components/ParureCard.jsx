...
const ParureCard = (props) => {
  ...
  const  duvet  = props.parure.parureContent.duvet;
  const  smallPillow  = props.parure.parureContent.smallPillow;
  const  mediumPillow  = props.parure.parureContent.mediumPillow;
  const  centerPillow  = props.parure.parureContent.centerPillow;
