...
const ParureCard = (props) => {
  ...
  const arrayParure = Object.keys(props.parure.parureContent);
  for (let i = 0; i < arrayParure.length; i++) {
    if (props.parure.parureContent[arrayParure[i]].id !== -1) {
      parureContentCart.push({ id: props.parure.parureContent[arrayParure[i]].id, stock: 1 });
    }
  }
