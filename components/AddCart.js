	...
	return(
		<div className={styles.addcart} >
			...
			<div className={styles.cartContent} >
				...
				{bigPillow.pillowName != base ? <CartItem image={bigPillow.pillowImage} name={bigPillow.pillowName} color={"Blanc"} widths={['140x200 cm','140x220 cm','200x200 cm','200x220 cm', '240x220 cm', '260x240 cm']} number={2} />: null }
				...
				{duvet.duvetName != base ? <CartItem image={duvet.duvetImage} name={duvet.duvetName} color={"Blanc"} widths={['140x200 cm','140x220 cm','200x200 cm','200x220 cm', '240x220 cm', '260x240 cm']} number={1} />: null }
				{flatSheet.sheetName != base ? <CartItem image={flatSheet.sheetImage} name={flatSheet.sheetName} color={"Blanc"} widths={['140x200 cm','140x220 cm','200x200 cm','200x220 cm', '240x220 cm', '260x240 cm']} number={1} />: null }
				{fittedSheet.sheetName != base ? <CartItem image={fittedSheet.sheetImage} name={fittedSheet.sheetName} color={"Blanc"} widths={['140x200 cm','140x220 cm','200x200 cm','200x220 cm', '240x220 cm', '260x240 cm']} number={1} />: null }
