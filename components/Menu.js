				...
				<div>
					<div className={styles.pillowSelector}>
						...
						{sizePillow == 'small' ?
							...
							<svg width="95" height="80" viewBox="0 0 95 80" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setSizePillow('small')}>
					...
					{sizePillow == 'small' ? 
						<div className={styles.articles}>			
							{articlesSmallPillow.map(article=>
								<Article size={sizePillow} idActiveArticle={idActiveSmallPillowArticle} onArticleChange={onArticleSmallPillowChange} onSmallPillowChange={props.onSmallPillowChange} {...article }  key={article.name} />
							)} 
						</div>
					...
					: sizePillow == 'medium' ? 
						<div className={styles.articles}>			
							{articlesMediumPillow.map(article=>
								<Article size={sizePillow} idActiveArticle={idActiveMediumPillowArticle} onArticleChange={onArticleMediumPillowChange} onMediumPillowChange={props.onMediumPillowChange} {...article }  key={article.name} />
							)} 
						</div>
					...
					: sizePillow == 'center' ? 
						<div className={styles.articles}>			
							{articlesCenterPillow.map(article=>
								<Article size={sizePillow} idActiveArticle={idActiveCenterPillowArticle} onArticleChange={onArticleCenterPillowChange} onCenterPillowChange={props.onCenterPillowChange} {...article }  key={article.name} />
							)} 
						</div>
					:				
						<div className={styles.articles}>			
							{articlesBigPillow.map(article=>
								<Article size={sizePillow} idActiveArticle={idActiveBigPillowArticle} onArticleChange={onArticleBigPillowChange} onBigPillowChange={props.onBigPillowChange} {...article }  key={article.name} />
							)} 
						</div>
					}
				</div>
